...
/**
 * Configure the application before listening
 *
 * @api private
 */
Server.prototype.init = function() {
    ...
    this.set('env', process.env.EXPRESS_ENV || (process.sparkEnv || {}).name || process.connectEnv.name);
...
/**
 * Start a server on the given FD
 *
 * @param {Number} FD
 * @api public
 */
...
Server.prototype.listenFD = function(fd) {
    ...
    connect.Server.prototype.listenFD.call(this, fd);
};
